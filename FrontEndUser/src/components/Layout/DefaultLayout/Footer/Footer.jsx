          ...
          <div className="col-lg-3 col-md-6 col-sm-6">
            <div className="footer__about">
              ...
              <ul>
                ...
                <li>{t('footer.phone')}: +65 11.188.888</li>
                <li>{t('footer.email')}: : hello@colorlib.com</li>
              </ul>
            </div>
          </div>
        ...
        <div className="row">
          <div className="col-lg-12">
            <div className="footer__copyright">
              ...
              <div className="footer__copyright__payment"><img src="assets/img/payment-item.png" /></div>
            </div>
          </div>
        </div>
      </div>
